...
public class IBufferEnvironmentPresetsMixin {
	...
	@WrapOperation(
			...
			at		= @At(
					value	= "FIELD",
					target	= "Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment$Presets;BLOCK:Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment;",
	...
	@WrapOperation(
			...
			at		= @At(
					value	= "FIELD",
					target	= "Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment$Presets;ENTITY:Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment;",
					opcode	= Opcodes.PUTSTATIC
			)
	)
	...
	@WrapOperation(
			...
			at		= @At(
					value	= "FIELD",
					target	= "Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment$Presets;POS_COLOR_TEX_LIGHT:Lcom/namelessgod2008/core/buffers/environments/IBufferEnvironment;",
					opcode	= Opcodes.PUTSTATIC
			)
	)
